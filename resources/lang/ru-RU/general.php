...
return [
    ...
    'importing_help'        => 'CSV-файл должен быть разделён запятыми и отформатирован с заголовками, соответствующими заголовкам в примерах CSV-файлов из документации</a>.',
